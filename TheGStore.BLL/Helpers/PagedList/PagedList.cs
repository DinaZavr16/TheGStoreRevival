...
{
    /// <summary>
    /// Represents the default implementation of the <see cref="IPagedList{TEntity}"/> interface.
    /// </summary>
    /// <typeparam name="TEntity">The type of the data to page</typeparam>
    public class PagedList<TEntity> : IPagedList<TEntity> where TEntity : class
    {
        ...
        internal PagedList(IEnumerable<TEntity> source, int pageIndex, int pageSize, int indexFrom)
        {

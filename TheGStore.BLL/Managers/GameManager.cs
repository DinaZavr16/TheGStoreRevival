...
namespace TheGStore.BLL.Managers
{
    public class GameManager : IGameManager
    {
        ...
        public GameManager(TheGStoreDbContext context, ILogger<GameManager> logger)
        {
            _context = context;
            _logger = logger;
        }

        public async Task<ResponseResult<IPagedList<GameUpdateModel>>> GetList(int pageIndex, int pageSize)
        {
        ...
        public async Task<ResponseResult<GameUpdateModel>> GetById(int id)
        {
            ResponseResult<GameUpdateModel> responseResult = new();

            try
            {
                var model = await _context.Games.ProjectToType<GameUpdateModel>().FirstOrDefaultAsync(x => x.Id == id);
        ...
        public async Task<ResponseResult<GameUpdateModel>> Create(GameModel model)
        {
            ResponseResult<GameUpdateModel> responseResult = new();
            ...
            try
            {
                var entity = model.Adapt<Game>();

                _context.Games.Add(entity);
                await _context.SaveChangesAsync();

                responseResult.Data = entity.Adapt<GameUpdateModel>();
        ...
        public async Task<ResponseResult<bool>> Update(GameUpdateModel model)
        {
